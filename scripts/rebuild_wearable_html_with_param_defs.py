#!/usr/bin/env python3
"""Rebuild wearable HTML with Parameter Definitions section at the end."""
...
def main() -> int:
    ...
    # Prefer Company Details as source of truth
    ...
    # Parameter definitions from original XY scoring audit
    ...
    audit = {
        "industry_group": xy.get("industry_group") or "Healthcare",
        "industry_category": xy.get("industry_category") or "Medical Devices",
        "axis_x": xy.get("axis_x") or "Clinical & Device Capability",
        "axis_y": xy.get("axis_y") or "Market Access & Growth Strategy",
        "x_features": xy.get("x_features") or [],
        "y_features": xy.get("y_features") or [],
        "parameter_definitions": param_defs,
        "quadrant_mid_x": xy.get("quadrant_mid_x"),
        "quadrant_mid_y": xy.get("quadrant_mid_y"),
    }
